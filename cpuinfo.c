...
static bool get_cpu_core_decription(char *features, int i) {
    if (features != NULL) {
        // Handle the core desciption portion of the output
        if (get_cpu_core_decription_entry(features,
                                          "hw.perflevel%d.name",
                                          i,
                                          true)) {
            strcat(features, ":");
            
            // Handle the count portion of the output
            return get_cpu_core_decription_entry(features,

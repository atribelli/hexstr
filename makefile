...
hexstr-a64intrin: a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64intrin.o
	g++ $(optdb) -o hexstr-a64intrin $(optcpp) $(optarch) a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64intrin.o
...
hexstr-a64asm: a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64asm.o
	g++ $(optdb) -o hexstr-a64asm $(optcpp) $(optarch) a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64asm.o

hexstr-a64asm.o: hexstr-a64.s
	as $(optdb) -o hexstr-a64asm.o $(optas) hexstr-a64.s

hexstr-a64neon: a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64neon.o
	g++ $(optdb) -o hexstr-a64neon $(optcpp) $(optarch) a64mainh.o a64cpuinfo.o a64hexstr-test.o hexstr-a64neon.o

...
hexstr-neon64: main.o hexstr-neon64.o
	g++ -o hexstr-neon64 -std=$(stdcpp) $(optcpp) main.o hexstr-neon64.o
...
clean:
	rm -f hexstr-c hexstr-intrin hexstr-a64 hexstr-neon64 hexstr-x64 hexstr-sse hexstr-avx a.out *.o
